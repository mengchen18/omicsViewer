...
* **Portable R:** To share the omicsViewer and data with users do not use docker, you can install omicsViewer in the [r portable](https://sourceforge.net/projects/rportable/).
